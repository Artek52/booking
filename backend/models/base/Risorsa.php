...
/**
 * This is the base model class for table "risorsa".
 *
 * @property integer $id
...
class Risorsa extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['struttura_id', 'created_by', 'updated_by', 'deleted_by'], 'integer'],
    ...
    public static function find()
    {
        $query = new \backend\models\RisorsaQuery(get_called_class());
        return $query->where(['risorsa.deleted_by' => 0]);
    }
}
